    ...
    return (
        <section className="relative px-6 lg:px-8  bg-linear-to-t from-amber-100 to-amber-50 flex   pt-6 sm:pt-6 md:pt-8    items-center  overflow-hidden">
            ...
            <div className="relative w-full max-w-7xl mx-auto flex flex-col z-10 px-5 pt-14 pb-5 md:pb-10  lg:px-8">
                ...
                <div className="relative mt-8 max-w-[400px] mx-auto p-[3px] rounded-[18px] bg-gradient-to-r from-amber-300 via-amber-500 to-amber-300 shadow-2xl shadow-amber-600/20 transition-transform hover:-translate-y-1">

                    {/* Badge Flottant "Offre Privilège" */}
                    ...
                    {/* Votre composant ImgCard existant */}
